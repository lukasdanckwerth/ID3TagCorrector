# ID3TagCorrector [![Build Status](https://travis-ci.com/lukasdanckwerth/ID3TagCorrector.svg?branch=master)](https://travis-ci.com/lukasdanckwerth/ID3TagCorrector)
